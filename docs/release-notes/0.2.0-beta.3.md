...
Beta.3 appliance QA is limited to the managed-install dialog and cancellation, with proof that no
Speedtest command is invoked. No package installation, real Speedtest, or other appliance mutation
is permitted; cancellation must leave the CLI uninvoked.
