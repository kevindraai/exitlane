...
- End the current NordVPN authentication session deliberately, then sign in with another token
  without rerunning setup. Ending the session also ends the active VPN tunnel.
